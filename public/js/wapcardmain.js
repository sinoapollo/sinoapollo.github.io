...
var Swiper = function(a, b) {
    ...
    if (window.getComputedStyle || (window.getComputedStyle = function(a) {
        ...
        C.callPlugins = function(a, b) {
            ...
            var d = C.h.getWidth(C.container), e = C.h.getHeight(C.container);
            if ((d !== C.width || e !== C.height || a) && 0 !== d && 0 !== e) {
                ...
                if (a && C.calcSlides(c), "auto" === b.slidesPerView) {
                    ...
                    for (C.snapGrid = [], C.slidesGrid = [], h = 0, l = 0; l < C.slides.length; l++) {
                        ...
                        var q = M ? f: g;
                        if (b.centeredSlides) {
                            var r = l === C.slides.length - 1 ? 0: C.slides[l + 1].getWidth(!0), s = l === C.slides.length - 1 ? 0: C.slides[l + 1].getHeight(!0), t = M ? r: s;
                            if (q > I) {
                    ...
                    m.style.width = "", m.style.height = "", i = C.slides[0].getWidth(!0), j = C.slides[0].getHeight(!0), F = M ? i : j, m.style.width = i + "px", m.style.height = j + "px", E = M ? i : j;
                else {
                    if (b.calculateHeight) {
                        ...
                        g = M ? C.height : C.height / b.slidesPerView, j = M ? C.height : C.slides.length * g;
        ...
        C.swipeNext = function(a) {
            ...
            if (C.initialized && 0 !== C.slides.length) {
                ...
                if (C.activeIndex === C.slides.length && (C.activeIndex = C.slides.length - 1), C.activeIndex < 0 && (C.activeIndex = 0), C.slides[C.activeIndex]) {
                    ...
                    for (var f = new RegExp("\\s*" + b.slideActiveClass), g = new RegExp("\\s*" + b.slideVisibleClass), h = 0; h < C.slides.length; h++)
                        C.slides[h].className = C.slides[h].className.replace(f, "").replace(g, ""), C.visibleSlides.indexOf(C.slides[h]) >= 0 && (C.slides[h].className += " " + b.slideVisibleClass);
        ...
        C.startAutoplay = function() {
            ...
            if (C.support.transitions) {
                ...
                ab && clearInterval(ab), ab = void 0, C.callPlugins("onAutoplayStop")
...
(function() {
    $(document).ready(function(e) {
        ...
        var nowday = new Date, tgday = new Date(Date.parse(yourtime));
        nowday > tgday && ($("#cityMain").attr({
            "data-original": "images/ikea_city_1.jpg"
        }), $("#cityMark").attr({
            "data-original": "images/ikea_city_1.png"
        }));
        var ikea_au = $(".ikea-audio").find(".music"), audio_switch_ikea=!0;
        ...
        var imgUrl = tmpLineLink + "/images/icon2.jpg", descContent = "\u6cd5\u81ea\u7136\u2022\u4e07\u8c61\u5f52", shareTitle = "\u8d22\u5bcc\u2022\u96ea\u5c71\u548c\u9662", appid = "";
